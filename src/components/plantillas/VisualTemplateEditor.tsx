        ...
        ? [
            {
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "De acuerdo a la legislación vigente, normas y políticas internas se inicia el presente proceso de adquisición/contratación para el cumplimiento de los objetivos operativos e institucionales de la Distribuidora de Electricidad ENDE DEORURO S.A.",
              subindices: [],
            },
            {
              id: "sec-2",
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "La presente contratación se justifica en la necesidad operativa de contar oportunamente con los bienes y servicios requeridos para el adecuado funcionamiento de las áreas de ENDE DEORURO S.A.",
            },
            {
              id: "sec-3",
              numero: 3,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Detalle técnico y especificaciones de los requerimientos según el cuadro y tablas a continuación:",
            },
            {
              id: "sec-4",
              numero: 4,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Los bienes deberán ser nuevos, de primer uso y fabricados bajo normas de calidad aplicables, o contar con los estándares de calidad y credenciales sanitarias vigentes correspondientes.",
            },
            {
              id: "sec-5",
              numero: 5,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Personal institucional y áreas operativas/administrativas de la Distribuidora de Electricidad ENDE DEORURO S.A.",
            },
            {
              id: "sec-6",
              numero: 6,
              titulo: "MÉTODO DE SELECCIÓN",
              pagina_estimada: 5,
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Menor Precio (Art. 31 del Reglamento SBC).",
            },
            {
              id: "sec-7",
              numero: 7,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Tendrá una validez mínima de 30 días calendario computables a partir de la fecha de presentación de la propuesta.",
            },
            {
              id: "sec-8",
              numero: 8,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Bienes y Suministros Oficiales / Servicios Ocupacionales.",
            },
            {
              id: "sec-9",
              numero: 9,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Instalaciones / Almacén Central de ENDE DEORURO S.A., ubicado en la ciudad de Oruro - Bolivia.",
            },
            {
              id: "sec-10",
              numero: 10,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Máximo 30 días calendario computables a partir del día siguiente hábil de la recepción formal de la Orden de Compra.",
            },
            {
              id: "sec-11",
              numero: 11,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "Por ítem requerido, formalizada mediante Orden de Compra (Art. 31 del Reglamento Específico del Sistema de Administración de Bienes y Servicios).",
            },
            {
              id: "sec-12",
              numero: 12,
              titulo: "PARA LA ACEPTACIÓN DEL LOTE / SERVICIO",
              pagina_estimada: 7,
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "El personal técnico de ENDE DEORURO realizará una evaluación técnica de conformidad el día de la entrega; en caso de existir observaciones o no cumplir especificaciones, se hará conocer inmediatamente.",
            },
            {
              id: "sec-13",
              numero: 13,
              ...
              showPrompt: false,
              prompt_ia: "",
              contenido_default: "El pago se realizará contra entrega satisfactoria del producto o servicio, conformidad emitida por ENDE DEORURO S.A. y entrega de la Nota de Entrega / Acta de Recepción, Solicitud de Pago y Factura oficial original.",
            },
            {
              id: "sec-14",
              numero: 14,
              titulo: "APLICACIÓN DE MULTAS",
              pagina_estimada: 7,
              showPrompt: false,
              prompt_ia: "",
          ...
          <div className="space-y-6 flex-1 py-2 font-sans">
            {seccionesPrompt.map((sec, idx) => (
              <div key={sec.id} className="space-y-3 p-4 rounded-xl border border-gray-200 bg-white hover:border-primary transition-colors group/sec shadow-sm">
                ...
                {/* SECCIÓN 3: ESPECIFICACIÓN TÉCNICA Y FORMATO DE TABLA */}
                {sec.numero === 3 && (plantilla.fk_carpeta === 1 || plantilla.fk_carpeta === 6) && (
